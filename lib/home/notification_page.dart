    ...
    return Scaffold(
        ...
        leading: IconButton(
          onPressed: () {
            ref
                ...
                .deleteNotification(notifications.first.id);
      ...
      body: _loading
        ...
        itemBuilder: (context, index) {
          ...
          return Dismissible(
            key: ValueKey(notif.id), // chiave unica per ogni notificazione
            direction: DismissDirection.endToStart, // swipe verso sinistra
            ...
            onDismissed: (direction) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("Notifica rimossa")),
              );
            },
            child: ListTile(
                ...
                children: [
                  ...
                  Consumer(
                    builder: (context, ref, _) {
                      final isRead = ref.watch(readNotificationProvider
                          .select((map) => map[notif.id] ?? false));
                      return isRead
                          ? Icon(Icons.verified_outlined, color: Colors.pink)
              ...
              onTap: () {
                // Segna come letta
                ref.read(readNotificationProvider.notifier).markAsRead(notif.id);
