...
import 'package:slowFit_client/home/home_client.dart';
...
import 'package:slowFit_client/widget/calendar_horizontal.dart';
                  ...
                  if (notifications.isNotEmpty)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(notifications.length.toString(), style: TextStyle(color: Colors.white, fontSize: 12), textAlign: TextAlign.center,),
                      ),
                    ),
                ],
              );
                  ...
                  if (selectedDate != null)
                    SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.24, // Imposta un'altezza adeguata
